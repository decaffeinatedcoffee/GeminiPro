...
int lastGstate = 0;
int switchsideAstatus;
int switchsideBstatus;
int lastswitchsideAstatus;
int lastswitchsideBstatus;
String lastColor;
int lastPir = 0;
...
void setup() {
 ...
 if(settingMode == true){
  ...
  lastswitchsideAstatus = digitalRead(D5);
  lastswitchsideBstatus = digitalRead(D6);
}
